...
func _ready() -> void:
	...
	encounter_table = []
	warp_table = {
		Vector2i(1, 7): {"scene": ROUTE_TO_LUMEN_SCENE, "route": &"route_to_lumen", "cell": Vector2i(21, 7)},
		Vector2i(18, 7): {"scene": ROUTE_TO_UMBRA_SCENE, "route": &"route_to_umbra", "cell": Vector2i(2, 7)},
	}
	super._ready()
